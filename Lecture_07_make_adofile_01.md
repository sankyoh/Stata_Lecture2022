...
# せっかく作ったpref2codeコマンドをいつでもつかいたい。

実用に耐えそうな出来になってきたので、いつでも使えるようにしたいと思います。

作成したadoファイルを適切なフォルダに入れておけば、いつでも利用できます。

```
adopath
```

![image](https://user-images.githubusercontent.com/67684585/221678038-ae29e23c-dfa8-4a47-aa4f-4fe80b06e4a8.png)

ここで示されたフォルダに入れておけばＯＫです。

Stataは上から順に優先しますが、個人的に作成したものであれば、(PERSONAL)でよいと思います。

なお、3番目は、ワーキングディレクトリを意味しています。
